...
&nbsp;
Via the stats.txt file generated by the Gem5 simulator, we can find information about Delay. It refers to the CPU's run time duration of the code that has been executed. Regarding Area variable, this can be found in the mcpat output results. For example, Xeon has an area of 410.507 mm^2. We can therefore calculate the sum of the energy as E = P \* t. The print_energy script will be used to calculate the power consumption. 
